...
//---- Top entity
module main #(
 parameter vd81687 = "firmware.list"
) (
 input [1:0] v2b2ed6,
 input vclk,
 output [7:0] v036815
);
 localparam p4 = vd81687;
 wire [0:7] w0;
 wire [0:1] w1;
 wire [0:1] w2;
 wire [0:7] w3;
...
//-- Button_tic_x2
//-- - - - - - - - - - - - - - - - - - - - - - - - --
//-- Configurable buttons (pull-up on/off. Not on/off) with tic output
//---------------------------------------------------
//---- Top entity
module v80ac84 (
 input vee8a83,
